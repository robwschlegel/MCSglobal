...
# Combine maps
ggsave("output/fig_S1.png", fig_S1, height = 4, width = 8)
ggsave("output/fig_S1.pdf", fig_S1, height = 4, width = 8)
fig_S1
```
...
fig_S2a <- FL_clim  %>% 
  ...
  guides(colour = guide_legend(override.aes = list(linetype = c("solid", "solid", "solid", "dashed", "dotdash", "dotted"),
                                                   size = c(1, 1, 1, 1, 1, 1)))) +
  labs(y = expression(paste("Temp. (°C)")), x = NULL) +
  theme(panel.border = element_rect(colour = "black", fill = NA))
# fig_S2a
...
ggsave("output/fig_S2.png", fig_S2, height = 8, width = 15)
ggsave("output/fig_S2.pdf", fig_S2, height = 8, width = 15)
```
