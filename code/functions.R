...
MCS_lon_files <- dir("../data/cat_lon_MCS", full.names = T)
MCS_cat_files <- dir("../data/cat_clim_MCS", full.names = T, recursive = T)
MCS_event_files <- dir("../data/event_MCS", full.names = T, pattern = "MCS")
